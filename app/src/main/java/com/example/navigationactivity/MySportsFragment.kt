...
class MySportsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<Button>(R.id.volleyball)?.setOnClickListener(
            Navigation.createNavigateOnClickListener(R.id.nav_mysports_to_volleyball, null)
        )

        view.findViewById<Button>(R.id.tennis)?.setOnClickListener(
            Navigation.createNavigateOnClickListener(R.id.nav_mysports_to_tennis, null)
        )
